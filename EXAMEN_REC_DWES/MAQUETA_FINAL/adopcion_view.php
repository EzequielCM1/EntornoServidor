...
<body>
    ...
    <header class="header-nav">
        <div class="wrapper header-inner">
            ...
            <nav class="nav-links">
                ...
                <!-- ### enlaces NUEVOS ### -->
                <a href="adopcion_view.php" class="nav-link activo">Centro de Adopción</a>
    ...
    <main class="wrapper">
        ...
        <div class="seccion-head">
            ...
            <span class="num-pill">3 registrados</span><!-- sustituir por el número de animales en_refugio=1-->
        </div>
            ...
            <article class="ficha-animal ficha-bloqueada"> <!-- clases: ficha-bloqueada o ficha-ok -->
                ...
                <div class="ficha-id">
                    <span class="ficha-nombre">
                        Nombre</span><!--sustituir por el nombre del animal-->
                    <span class="ficha-raza">Felino · Raza del animal</span>
                ...
                <div class="ficha-datos">
                    <span class="dato-pill">
                        ...
                        <span class="dato-valor">1 años</span><!--sustituir por los años del animal-->
                    </span>
                    <span class="dato-pill">
                        <span class="dato-icono">⚖️</span>
                        <span class="dato-valor">2.50 kg</span><!--sustituir por el peso del animal-->
                    </span>
                    <span class="dato-pill">
                        <span class="dato-icono">⚡</span>
                        <span class="dato-valor">25%</span><!--sustituir por la energía del animal-->
                    </span>
                    <span class="dato-pill">
                        <span class="dato-icono">🧼</span>
