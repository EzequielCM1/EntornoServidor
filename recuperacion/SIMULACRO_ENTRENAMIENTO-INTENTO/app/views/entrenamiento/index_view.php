    ...
    <header class="header-nav">
        <div class="wrapper header-inner">
            ...
            <nav class="nav-links">
                ...
                <a href="nuevoanimal" class="nav-link">Nuevo Animal</a>
            </nav>
                ...
                <?php foreach ($animales as $animal) : ?>
                    <article class="card">
                        <div class="card-img-box">
                            <img src="img/<?= $animal['imagen'] ?>" alt="<?= $animal['nombre'] ?>" class="card-img" onerror="this.src='https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=500&auto=format&fit=crop'">
