...
<body>
    ...
    <header class="header-nav">
        <div class="wrapper header-inner">
            ...
            <nav class="nav-links">
                <a href="<?= BASE_URL ?>" class="nav-link">Panel de Control</a>
                <a href="nuevoanimal" class="nav-link activo">Nuevo Rescate</a>
            </nav>
    ...
    <main class="wrapper">
        <section class="seccion-head">
            <a href="<?= BASE_URL ?>" style="text-decoration: none; color: var(--tierra); font-weight: 600;">← Volver al listado</a>
            <h2>Registrar Nuevo Rescate</h2>
        </section>

        <!-- Mensaje Flash -->
        <?php if ($mensajeFlash): ?>
            <div class="flash flash-<?= $mensajeFlash['tipo'] ?>" style="margin-bottom: 20px; padding: 15px; border-radius: 8px; background: <?= $mensajeFlash['tipo'] == 'exito' ? '#d4edda' : '#f8d7da' ?>; color: <?= $mensajeFlash['tipo'] == 'exito' ? '#155724' : '#721c24' ?>;">
        ...
        <div class="card" style="max-width: 700px; margin: 0 auto; padding: 40px;">
            <form action="nuevoanimal" method="POST">
                
                <div class="form-group" style="margin-bottom: 25px;">
                    <label style="display: block; font-weight: 600; margin-bottom: 8px;">Nombre del Animal *</label>
                    <input type="text" name="nombre" value="<?= $nombre ?>" class="input-c" style="width: 100%;" placeholder="Ej: Toby">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 25px;">
                    <div class="form-group">
                        ...
                        <select name="especie" class="input-c" style="width: 100%; height: 45px;">
                            ...
                            <option value="canino" <?= ($especie == 'canino') ? 'selected' : '' ?>>Canino</option>
                            <option value="felino" <?= ($especie == 'felino') ? 'selected' : '' ?>>Felino</option>
                            <option value="otro" <?= ($especie == 'otro') ? 'selected' : '' ?>>Otro</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="raza" value="<?= $raza ?>" class="input-c" style="width: 100%;" placeholder="Ej: Husky">
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 25px;">
                    <div class="form-group">
                        ...
                        <input type="number" name="edad" value="<?= $edad ?>" class="input-c" style="width: 100%;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.1" name="peso" value="<?= $peso ?>" class="input-c" style="width: 100%;">
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 30px;">
                    <div class="form-group">
                        ...
                        <input type="number" name="nivel_adiestramiento" min="1" max="10" value="<?= $nivel_adiestramiento ?>" class="input-c" style="width: 100%;">
                    </div>
                    <div class="form-group">
                        <label style="display: block; font-weight: 600; margin-bottom: 8px;">Puntos Expediente (0-100)</label>
                        <input type="number" name="puntos_expediente" min="0" max="100" value="<?= $puntos_expediente ?>" class="input-c" style="width: 100%;">
                    </div>
                </div>
