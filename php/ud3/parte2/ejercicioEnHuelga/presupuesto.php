...
<body>
    ...
    <main>
        ...
        <a href="http://localhost/php/ud3/parte2/ejercicioEnHuelga/presupuesto.php?destino=roma&personas=3&dias=5">Prueba1</a><br>
        <a href="http://localhost/php/ud3/parte2/ejercicioEnHuelga/presupuesto.php?destino=paris&personas=2&dias=8">Prueba2</a><br>
        <a href="http://localhost/php/ud3/parte2/ejercicioEnHuelga/presupuesto.php?destino=lisboa&personas=4&dias=3">Prueba3</a><br>
    </main>
    <footer>
        <p>P.Lluyot</p>
    </footer>
