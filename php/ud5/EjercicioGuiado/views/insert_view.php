...
<body class="p-4">
    ...
    <!-- Contenedor principal de la tarjeta de creación, centrado y responsive -->
    <div class="create-card bg-white p-8 sm:p-10 rounded-3xl w-full max-w-lg mx-auto">
        ...
        <header class="text-center mb-8">
            ...
            <p class="mt-2 text-sm text-gray-500">
                Completa la información para crear un nuevo artículo en el inventario.
            </p>
        </header>
        ...
        <form class="space-y-6" method="post">
            ...
            <div>
                ...
                <textarea 
                    ...
                    name="description" 
                    rows="4"
                    placeholder="Características y especificaciones del producto."
            ...
            <div>
                <button 
                    type="submit" 
                    class="btn-submit w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-md text-sm font-bold text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                >
                    Crear Producto
                </button>
            </div>
