...
<body>
   ...
   <div class="insertar">
        <a href="insert.php?">Insertar uno Nuevo</a>
   </div>
       ...
       <tbody>
           <?php foreach ($lista_productos as $prod): ?>
               <tr>
                   ...
                   <td>
                    <a href="productos_borrar.php?id=<?= $prod['id_producto'] ?>">Eliminar</a>
                    <a href="update.php?id=<?= $prod['id_producto'] ?>">Actualizar</a>
                   </td>
               </tr>
           <?php endforeach; ?>
       </tbody>
            ...
            <?php else : ?>
                <div>
                    <h4>No existe ningun producto ahora mismo</h4>
                </div>
            <?php endif; ?>
</body>
</html>