            ...
            <section class="card">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="asunto" name="asunto" placeholder="Ej: Error PC01" value="<?= $asunto ?>">
                        <!-- Placeholder para mensaje de error -->
                        <?php if (!empty($errores['asunto'])): ?>
                            <span class="validation-error" id="error-asunto"><?= $errores['asunto'] ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php if (!empty($errores['tipo'])): ?>
                            <span class="validation-error" id="error-asunto"><?= $errores['tipo'] ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group form-col-50">
                            ...
                            <input type="number" id="horas_estimadas" name="horas_estimadas" placeholder="Ej: 2" value="<?= $horas ?>">
                            <!-- Placeholder para mensaje de error -->
                            <?php if (!empty($errores['horas'])): ?>
                                <span class="validation-error" id="error-asunto"><?= $errores['horas'] ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                    <!-- Botones de Acción -->
